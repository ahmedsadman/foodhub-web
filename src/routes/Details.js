...
class Details extends Component {
	...
	handleOrderExit = async () => {
		...
		const res = await this.swal.fire({
			text:
				'Items on the cart will be reset. Are you sure you want to exit?',
			type: 'warning',
	...
	async fetchDetails() {
		...
		console.log('fetch id', params);
		try {
			const response = await axios.get(
				`${api.restaurantDetails}/${params.id}`
			);
						...
						<div className={styles.box2}>
							...
							<div className={styles.reviewRatings}>
								...
								<div className={styles.rating}>
									<div
										className={`${styles.food} ${styles.orange}`}
									>
										Food
										<span
										...
										<div
											className={`${styles.small} ${styles.ash}`}
										>
									...
									<div
										className={`${styles.environment} ${styles.orange}`}
									>
										Environment
										<span
											className={styles.individualRating}
									...
									<div
										className={`${styles.service} ${styles.orange}`}
									>
										Service
										<span
											className={styles.individualRating}
									...
									<div
										className={`${styles.price} ${styles.orange}`}
									>
										Price
										<span
											className={styles.individualRating}
							...
							<div className={styles.rightBar}>
								...
								<div className={styles.medium}>
									...
									>
										Type: {data.restaurant_type.join(', ')}
									</span>
									<FeatureLabel
